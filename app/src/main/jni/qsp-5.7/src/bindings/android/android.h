...
QSP_EXTERN QSP_BOOL QSPGetExprValue(const QSP_CHAR *str,
									QSP_BOOL *isString,
									int *numVal,
									QSP_CHAR *strVal,
									int strValBufSize);
...
QSP_EXTERN void QSPGetLastErrorData(int *errorNum,
									QSP_CHAR **errorLoc,
									int *errorActIndex,
									int *errorLine);
...
QSP_EXTERN QSP_BOOL QSPSaveGameAsString(QSP_CHAR *strBuf,
										int strBufSize,
										int *realSize,
										QSP_BOOL isRefresh); // In memory
QSP_EXTERN QSP_BOOL QSPOpenSavedGame(const QSP_CHAR *file, QSP_BOOL isRefresh); // In file
QSP_EXTERN QSP_BOOL QSPOpenSavedGameFromData(const void *data,
											 int dataSize,
											 QSP_BOOL isRefresh); // In memory
QSP_EXTERN QSP_BOOL QSPOpenSavedGameFromString(const QSP_CHAR *str,
											   QSP_BOOL isRefresh); // In memory
