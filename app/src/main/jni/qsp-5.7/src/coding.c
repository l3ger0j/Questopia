...
unsigned char qspCP1251ToKOI8RTable[] =
	{
		...
		0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
		0x20,
		0x9A, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0xB3, 0xBF, 0x20, 0x20, 0x20, 0x20, 0x20,
		0x20,
		0x9C, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20, 0x9E, 0xA3, 0x20, 0x20, 0x20, 0x20, 0x20, 0x20,
		0x20,
...
unsigned int qspKOI8RToUnicodeTable[] =
	{
...
unsigned int qspCP1251ToUnicodeTable[] =
	{
...
unsigned char qspCP1251ToUpperTable[] =
	{
		...
		0x5F,
		0x60, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4A, 0x4B, 0x4C, 0x4D, 0x4E,
		0x4F,
		0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5A, 0x7B, 0x7C, 0x7D, 0x7E,
		0x7F,
		0x80, 0x81, 0x82, 0x81, 0x84, 0x85, 0x86, 0x87, 0x88, 0x89, 0x8A, 0x8B, 0x8C, 0x8D, 0x8E,
		0x8F,
		0x80, 0x91, 0x92, 0x93, 0x94, 0x95, 0x96, 0x97, 0x98, 0x99, 0x8A, 0x9B, 0x8C, 0x8D, 0x8E,
		0x8F,
		0xA0, 0xA1, 0xA1, 0xA3, 0xA4, 0xA5, 0xA6, 0xA7, 0xA8, 0xA9, 0xAA, 0xAB, 0xAC, 0xAD, 0xAE,
		0xAF,
		0xB0, 0xB1, 0xB2, 0xB2, 0xA5, 0xB5, 0xB6, 0xB7, 0xA8, 0xB9, 0xAA, 0xBB, 0xA3, 0xBD, 0xBD,
		0xAF,
...
unsigned char qspCP1251ToLowerTable[] =
	{
		...
		0x7F,
		0x90, 0x83, 0x82, 0x83, 0x84, 0x85, 0x86, 0x87, 0x88, 0x89, 0x9A, 0x8B, 0x9C, 0x9D, 0x9E,
		0x9F,
		0x90, 0x91, 0x92, 0x93, 0x94, 0x95, 0x96, 0x97, 0x98, 0x99, 0x9A, 0x9B, 0x9C, 0x9D, 0x9E,
		0x9F,
		0xA0, 0xA2, 0xA2, 0xBC, 0xA4, 0xB4, 0xA6, 0xA7, 0xB8, 0xA9, 0xBA, 0xAB, 0xAC, 0xAD, 0xAE,
		0xBF,
		0xB0, 0xB1, 0xB3, 0xB3, 0xB4, 0xB5, 0xB6, 0xB7, 0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBE, 0xBE,
		0xBF,
...
unsigned char qspKOI8RToUpperTable[] =
	{
		...
		0x90, 0x91, 0x92, 0x93, 0x94, 0x95, 0x96, 0x97, 0x98, 0x99, 0x9A, 0x9B, 0x9C, 0x9D, 0x9E,
		0x9F,
		0xA0, 0xA1, 0xA2, 0xB3, 0xA4, 0xA5, 0xA6, 0xA7, 0xA8, 0xA9, 0xAA, 0xAB, 0xAC, 0xAD, 0xAE,
		0xAF,
...
unsigned char qspKOI8RToLowerTable[] =
	{
		...
		0xAF,
		0xB0, 0xB1, 0xB2, 0xA3, 0xB4, 0xB5, 0xB6, 0xB7, 0xB8, 0xB9, 0xBA, 0xBB, 0xBC, 0xBD, 0xBE,
		0xBF,
		0xC0, 0xC1, 0xC2, 0xC3, 0xC4, 0xC5, 0xC6, 0xC7, 0xC8, 0xC9, 0xCA, 0xCB, 0xCC, 0xCD, 0xCE,
		0xCF,
		0xD0, 0xD1, 0xD2, 0xD3, 0xD4, 0xD5, 0xD6, 0xD7, 0xD8, 0xD9, 0xDA, 0xDB, 0xDC, 0xDD, 0xDE,
...
unsigned char qspCP1251OrderTable[] =
	{
		...
		0x80,
		0x91, 0x92, 0xF2, 0xE0, 0xF5, 0xF9, 0xF6, 0xF7, 0xFD, 0xFA, 0x98, 0xFB, 0x99, 0x9B, 0x9A,
		0x9D,
		0xDF, 0xF0, 0xF1, 0xF3, 0xF4, 0xF8, 0xEE, 0xEF, 0x20, 0xFF, 0xE6, 0xFC, 0xE7, 0xE9, 0xE8,
		0xEB,
		0x81, 0x9C, 0xEA, 0x97, 0x82, 0xEC, 0x83, 0x84, 0x90, 0x85, 0x93, 0x86, 0x87, 0x88, 0x89,
		0x96,
		0x8A, 0x8B, 0x95, 0xE3, 0xED, 0x8C, 0x8D, 0x8E, 0xDE, 0xFE, 0xE1, 0x8F, 0xE5, 0x94, 0xE2,
		0xE4,
...
unsigned char qspKOI8ROrderTable[] =
	{
		...
		
	};
...
static unsigned int qspDirectConvertUC(char, unsigned int *);
static char qspReverseConvertUC(unsigned int, unsigned int *);
...
static unsigned int qspDirectConvertUC(char ch, unsigned int *table) {
  unsigned char ch2 = (unsigned char)ch;
  return (ch2 >= 0x80 ? table[ch2 - 0x80] : ch);
}

static char qspReverseConvertUC(unsigned int ch, unsigned int *table) {
  int i;
