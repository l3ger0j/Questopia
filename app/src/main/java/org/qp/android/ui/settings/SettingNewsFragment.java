...
public class SettingNewsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        var background = ResourcesCompat.getColor(getResources(), android.R.color.darker_gray, requireContext().getTheme());
        ...
        newsBinding.newsView.setBackgroundColor(background);
