...
import org.qp.android.domain.model.TempFile;
import org.qp.android.domain.model.TempFileType;
import org.qp.android.domain.repository.LocalRepository;
import org.qp.android.domain.repository.RemoteRepository;
import org.qp.android.helpers.ErrorType;
import org.qp.android.helpers.archive.ArchiveUnpack;
import org.qp.android.helpers.bus.Events;
import org.qp.android.helpers.notify.NotifyBuilder;
import org.qp.android.presentation.dialogs.StockDialogFrags;
import org.qp.android.presentation.dialogs.StockDialogType;
import org.qp.android.presentation.game.GameActivity;
...
public class StockViewModel extends AndroidViewModel {
    ...
    public StockViewModel(@NonNull Application application,
        ...
        initRecycler(remoteRepository.fetchRemoteSource());
    }

    private void initRecycler(RxPagingSource<Integer, Game> source) {
    ...
    public CompletableFuture<List<Game>> getListGamesFuture() {
        return localRepository.getAllGameEntries();
    }
    ...
    public void onUpdateSelection(long key, boolean selected) {
        localRepository.getGameEntryById(key)
    ...
    public void createAddIntent(Game unfilledEntry, DocumentFile rootDir) {
        try {
            ...
            CompletableFuture
                    ...
                    .thenComposeAsync(list -> localRepository.fillAndInsertEntry(unfilledEntry, rootDir, list))
    ...
    public void createEditIntent(Game unfilledEntry) {
        try {
            ...
            localRepository.updateEntry(currGameEntry)
                    .thenRun(this::loadGameDataFromDB)
    ...
    public void loadGameDataFromDB() {
        localRepository.getAllGameEntries()
    ...
    public CompletableFuture<Void> removeEntryFromDB(List<Game> entriesDelete) {
        return localRepository.deleteGamesEntries(entriesDelete)
                    ...
                    CompletableFuture
                            ...
                            .thenApplyAsync(gameFiles -> {
                                if (gameFiles.isEmpty()) {
                                    ...
                                    localRepository.fillAndInsertEntry(currGameEntry, gameFolder, gameFiles);
                                    return true;
                                }
                            }, executor)
                            .thenAccept(aBoolean -> {
